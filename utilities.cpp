...
save_image("symetrize1.png", img_sym, w, h, chnls);
...
save_image("symetrize2.png", img_sym, w, h, chnls);
        ...
        save_image("symetrize3.png", img_sym, w, h, chnls);
...
/**
 * @brief Для удобства. Оцените размер вектора ind_set, построенного
 * с помощью функции ind_initialize().
 *
 * @return Размер вектора ind_set, построенного в ind_initialize().
 **/
unsigned ind_size(
    const unsigned max_size
, const unsigned N
